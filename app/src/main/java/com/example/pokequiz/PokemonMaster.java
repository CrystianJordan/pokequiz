...
public class PokemonMaster extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pokemon_master);
        TextView rightCount;
        Button play;
...
play.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent i = new Intent(PokemonMaster.this,MainActivity.class);
        startActivity(i);
    }
});
    }
